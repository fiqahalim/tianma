...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                <a href="{{ route('user.transaction.index', [$order->id]) }}">Transaction List</a>
            </li>
        </ol>
    </nav>
    ...
    <div class="container mb-3">
        <div class="my-5">
            <form action="{{ route('user.transaction.index', [$order->id]) }}" method="GET">
                                ...
                                <tbody class="text-95 text-secondary-d3">
                                    @foreach($transactions as $transaction)
                                        <tr data-entry-id="{{ $transaction->id }}">
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-primary" href="{{ route('user.transaction.show', $transaction->id) }}">
                                                    View
                                                </a>
                                            </td>
                                        </tr>
