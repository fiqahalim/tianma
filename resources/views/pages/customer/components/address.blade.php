...
<div class="form-row">
    <div class="form-group col-md-6 ml-2">
        <div class="form-check">
            <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" style="width:10px;" onclick="FillAddressInput()">
...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        <input class="form-control {{ $errors->has('curaddress_1') ? 'is-invalid' : '' }}" type="text" name="curaddress_1" id="curaddress_1" value="{{ old('curaddress_1', '') }}">
        @if($errors->has('curaddress_1'))
            <div class="invalid-feedback">
                {{ $errors->first('curaddress_1') }}
            </div>
        @endif
        <span class="help-block">{{ trans('cruds.customer.fields.address_1_helper') }}</span>
    </div>
    <div class="form-group col-md-6">
        ...
        <input class="form-control {{ $errors->has('curaddress_2') ? 'is-invalid' : '' }}" type="text" name="curaddress_2" id="curaddress_2" value="{{ old('curaddress_2', '') }}">
...
<div class="form-row">
    <div class="form-group col-md-2">
        ...
        <input class="form-control {{ $errors->has('curpostcode') ? 'is-invalid' : '' }}" type="text" name="curpostcode" id="curpostcode" value="{{ old('curpostcode', '') }}" step="1">
    ...
    <div class="form-group col-md-2">
        ...
        <input class="form-control {{ $errors->has('curstate') ? 'is-invalid' : '' }}" type="text" name="curstate" id="curstate" value="{{ old('curstate', '') }}">
    ...
    <div class="form-group col-md-2">
        ...
        <input class="form-control {{ $errors->has('curcity') ? 'is-invalid' : '' }}" type="text" name="curcity" id="curcity" value="{{ old('curcity', '') }}">
    ...
    <div class="form-group col-md-3">
        ...
        <input class="form-control {{ $errors->has('curnationality') ? 'is-invalid' : '' }}" type="text" name="curnationality" id="curnationality" value="{{ old('curnationality', '') }}">
    ...
    <div class="form-group col-md-3">
        ...
        <input class="form-control {{ $errors->has('curcountry') ? 'is-invalid' : '' }}" type="text" name="curcountry" id="curcountry" value="{{ old('curcountry', '') }}">
