...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">View {{ trans('cruds.userAlert.title') }}</li>
    </ol>
</nav>
        ...
        <div class="form-group">
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.userAlert.fields.attachment') }}
                        </th>
                        <td>
                            @foreach($userAlert->attachment as $key => $media)
