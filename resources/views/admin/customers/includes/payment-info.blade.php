    ...
    <div class="col">
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control" id="mode" type="text" value="{{ old('mode', $order->customer->mode) }}" readonly>
            </div>
        </div>
    </div>
    <div class="col">
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <input class="form-control" id="contact_person_name" type="text" value="{{ old('contact_person_name', $order->customer->contact_person_name) }}" readonly>
            </div>
            <div class="form-group col-md-6">
                <label for="cperson_id_number">NRIC/Passport No.</label>
                <input class="form-control" id="cperson_id_number" type="text" value="{{ old('cperson_id_number', $order->customer->cperson_id_number) }}" readonly>
            </div>
            <div class="form-group col-md-6">
                <label for="mode">Contact No.</label>
                <input class="form-control" id="mode" type="text" value="{{ old('contact_person_no', $order->customer->contact_person_no) }}" readonly>
            </div>
        </div>
    </div>
</div>
