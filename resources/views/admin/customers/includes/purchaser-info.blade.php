...
<div class="form-row">
    <div class="form-group col-md-3">
        ...
        <input class="form-control" id="full_name" type="name" value="{{ old('full_name', $order->customer->full_name) }}" readonly>
    </div>
    <div class="form-group col-md-2">
        <label for="id_number">{{ trans('cruds.customer.fields.id_number') }}</label>
        <input class="form-control" id="id_number" type="text" value="{{ old('id_number', $order->customer->id_number ) }}" readonly>
    </div>
    <div class="form-group col-md-2">
        <label for="gender">Gender</label>
        <input class="form-control" id="gender" type="text" value="{{ old('gender', $order->customer->gender) }}" readonly>
    </div>
    <div class="form-group col-md-2">
        <label for="contact_person_no">Mobile</label>
        <input class="form-control" id="contact_person_no" type="text" value="{{ old('contact_person_no', $order->customer->contact_person_no) }}" readonly>
    </div>
    <div class="form-group col-md-3">
        <label for="email">Email</label>
        <input class="form-control" id="email" type="text" value="{{ old('email', $order->customer->email) }}" readonly>
    </div>
</div>
