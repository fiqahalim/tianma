...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit Deceased Person</li>
        </ol>
    </nav>

    <div class="card">
        <div class="card-header font-weight-bold">
            {{ trans('global.edit') }} Deceased Person Information
        </div>
            ...
            <form method="POST" action="{{ route("admin.decease-people.update", [$decease_person->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('decease_name') ? 'is-invalid' : '' }}" type="text" name="decease_name" id="decease_name" value="{{ old('decease_name', $decease_person->decease_name) }}" required>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control {{ $errors->has('decease_id_number') ? 'is-invalid' : '' }}" type="text" name="decease_id_number" id="decease_id_number" value="{{ old('decease_id_number', $decease_person->decease_id_number) }}" required>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control {{ $errors->has('decease_gender') ? 'is-invalid' : '' }}" name="decease_gender" id="decease_gender">
                            ...
                            @foreach(App\Models\Decease::GENDER_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('decease_gender', $decease_person->decease_gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control date {{ $errors->has('birth_date') ? 'is-invalid' : '' }}" type="text" name="birth_date" id="birth_date" value="{{ old('birth_date', $decease_person->birth_date) }}">
                    ...
                    <div class="form-group col-md-2">
                        <label for="decease_religion">Deceased Religion</label>
                        <input class="form-control {{ $errors->has('decease_religion') ? 'is-invalid' : '' }}" type="text" name="decease_religion" id="decease_religion" value="{{ old('decease_religion', $decease_person->decease_religion) }}">
                        @if($errors->has('decease_religion'))
                            <div class="invalid-feedback">
                                {{ $errors->first('decease_religion') }}
                            </div>
                        @endif
                        <span class="help-block">{{ trans('cruds.customer.fields.full_name_helper') }}</span>
                    </div>
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control {{ $errors->has('decease_maritial') ? 'is-invalid' : '' }}" name="decease_maritial" id="decease_maritial">
                            ...
                            @foreach(App\Models\Decease::MARITAL_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('decease_maritial', $decease_person->decease_maritial) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                        @if($errors->has('decease_gender'))
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control {{ $errors->has('decease_dialect') ? 'is-invalid' : '' }}" type="text" name="decease_dialect" id="decease_dialect" value="{{ old('decease_dialect', $decease_person->decease_dialect) }}">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control {{ $errors->has('decease_national') ? 'is-invalid' : '' }}" type="text" name="decease_national" id="decease_national" value="{{ old('decease_national', $decease_person->decease_national) }}">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control {{ $errors->has('decease_income') ? 'is-invalid' : '' }}" type="text" name="decease_income" id="decease_income" value="{{ old('decease_income', $decease_person->decease_income) }}">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control {{ $errors->has('decease_occupation') ? 'is-invalid' : '' }}" type="text" name="decease_occupation" id="decease_occupation" value="{{ old('decease_occupation', $decease_person->decease_occupation) }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('ref_no') ? 'is-invalid' : '' }}" type="text" name="ref_no" id="ref_no" value="{{ old('ref_no', $decease_person->ref_no) }}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('bury_cert') ? 'is-invalid' : '' }}" type="text" name="bury_cert" id="bury_cert" value="{{ old('bury_cert', $decease_person->bury_cert) }}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('cremation_cert') ? 'is-invalid' : '' }}" type="text" name="cremation_cert" id="cremation_cert" value="{{ old('cremation_cert', $decease_person->cremation_cert) }}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('casket') ? 'is-invalid' : '' }}" type="text" name="casket" id="casket" value="{{ old('casket', $decease_person->casket) }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control {{ $errors->has('undertaker') ? 'is-invalid' : '' }}" type="text" name="undertaker" id="undertaker" value="{{ old('undertaker', $decease_person->undertaker) }}">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control {{ $errors->has('open_niche') ? 'is-invalid' : '' }}" type="text" name="open_niche" id="open_niche" value="{{ old('open_niche', $decease_person->open_niche) }}">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control {{ $errors->has('miling_flag') ? 'is-invalid' : '' }}" name="miling_flag" id="miling_flag">
                            ...
                            @foreach(App\Models\Decease::MAILING_FLAG as $key => $label)
                                <option value="{{ $key }}" {{ old('miling_flag', $decease_person->miling_flag) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                        @if($errors->has('decease_gender'))
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control datetime {{ $errors->has('death_date') ? 'is-invalid' : '' }}" name="death_date" id="death_date" value="{{ old('death_date', $decease_person->death_date) }}">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control datetime {{ $errors->has('grain_date') ? 'is-invalid' : '' }}" name="grain_date" id="grain_date" value="{{ old('grain_date', $decease_person->grain_date) }}">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input class="form-control datetime {{ $errors->has('bury_date') ? 'is-invalid' : '' }}" name="bury_date" id="bury_date" value="{{ old('bury_date', $decease_person->bury_date) }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('issue_address_1') ? 'is-invalid' : '' }}" type="text" name="issue_address_1" id="issue_address_1" value="{{ old('issue_address_1', $decease_person->issue_address_1) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('issue_address_2') ? 'is-invalid' : '' }}" type="text" name="issue_address_2" id="issue_address_2" value="{{ old('issue_address_2', $decease_person->issue_address_2) }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('issue_postcode') ? 'is-invalid' : '' }}" type="number" name="issue_postcode" id="issue_postcode" value="{{ old('issue_postcode', $decease_person->issue_postcode) }}" step="1">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('issue_state') ? 'is-invalid' : '' }}" type="text" name="issue_state" id="issue_state" value="{{ old('issue_state', $decease_person->issue_state) }}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('issue_city') ? 'is-invalid' : '' }}" type="text" name="issue_city" id="issue_city" value="{{ old('issue_city', $decease_person->issue_city) }}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('issue_country') ? 'is-invalid' : '' }}" type="text" name="issue_country" id="issue_country" value="{{ old('issue_country', $decease_person->issue_country) }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('funeral_address_1') ? 'is-invalid' : '' }}" type="text" name="funeral_address_1" id="funeral_address_1" value="{{ old('funeral_address_1', $decease_person->funeral_address_1) }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('funeral_address_2') ? 'is-invalid' : '' }}" type="text" name="funeral_address_2" id="funeral_address_2" value="{{ old('funeral_address_2', $decease_person->funeral_address_2) }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('funeral_postcode') ? 'is-invalid' : '' }}" type="number" name="funeral_postcode" id="funeral_postcode" value="{{ old('funeral_postcode', $decease_person->funeral_postcode) }}" step="1">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('funeral_state') ? 'is-invalid' : '' }}" type="text" name="funeral_state" id="funeral_state" value="{{ old('funeral_state', $decease_person->funeral_state) }}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('funeral_city') ? 'is-invalid' : '' }}" type="text" name="funeral_city" id="funeral_city" value="{{ old('funeral_city', $decease_person->funeral_city) }}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control {{ $errors->has('funeral_country') ? 'is-invalid' : '' }}" type="text" name="funeral_country" id="funeral_country" value="{{ old('funeral_country', $decease_person->funeral_country) }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <textarea class="form-control {{ $errors->has('remark') ? 'is-invalid' : '' }}" name="remark" id="remark">{{ old('remark', $decease_person->remark) }}</textarea>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <textarea class="form-control {{ $errors->has('item_elements') ? 'is-invalid' : '' }}" name="item_elements" id="item_elements">{{ old('item_elements', $decease_person->item_elements) }}</textarea>
