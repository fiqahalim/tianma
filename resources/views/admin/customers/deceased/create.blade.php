...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Create {{ trans('cruds.customer.title') }}</li>
    </ol>
</nav>
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.decease-people.store") }}" enctype="multipart/form-data">
            @csrf
