                    ...
                    @if(isset($intendedUsers))
                        @foreach($intendedUsers as $key => $intendedUser)
                            <tr data-entry-id="{{ $intendedUser->id }}">
                                ...
                                <td>
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.intended-users.show', $intendedUser->id) }}">
                                        <i class="fas fa-eye"></i>
                                    </a>

                                    <a class="btn btn-xs btn-info" href="{{ route('admin.intended-users.edit', $intendedUser->id) }}">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>

                                    <form action="{{ route('admin.intended-users.destroy', $intendedUser->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
