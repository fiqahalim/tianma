...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">
            <a href="{{ route('admin.agentsReport.index') }}">Registered Agents Report</a>
        </li>
    </ol>
</nav>
...
<div class="card">
    <div class="card-header font-weight-bold">
        Registered Agents Report {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <div class="mb-5">
            <form action="{{ route('admin.agentsReport.index') }}" method="GET">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover datatable-agentReport">
                <thead>
                    <tr>
                        <th width="10"></th>
...
<script>
  ...
  let table = $('.datatable-agentReport:not(.ajaxTable)').DataTable({ buttons: dtButtons })
