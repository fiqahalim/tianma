...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                Create {{ trans('cruds.addOnProduct.title_singular') }}
            </li>
        </ol>
    </nav>
    ...
    <div class="card">
        <div class="card-header font-weight-bold">
            {{ trans('global.create') }} {{ trans('cruds.addOnProduct.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.add-on-products.store") }}" enctype="multipart/form-data">
                @csrf
