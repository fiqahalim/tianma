                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-1">
                                <i class="fa fa-phone fa-flip-horizontal text-secondary"></i> <b class="text-600">{{ $commission->orders->customer->contact_person_no }}</b>
                            </div>
                            <div class="my-1">
                                <span class="text-sm text-grey-m2 align-middle">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            <div class="row my-2">
                                ...
                                <div class="col-5">
                                    <span class="text-120 text-secondary-d1">RM 2,250</span>
                                </div>
                            </div>
