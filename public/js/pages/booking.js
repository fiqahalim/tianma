...
function updateState() {
  ...
  document.querySelector('#count').innerText = selectedSeatsNumber; // document.querySelector('#total').innerText = selectedSeatsNumber * ticketPrice;
